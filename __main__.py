...
from ngsi_formatter import NGSIFormatter
from orion_publisher import publish_to_orion
        ...
        for sensor in sensors:
            ...
            try:
                ...
                for m in measurements[:10]:  # limitar a 10 por sensor
                    ...
                    publish_to_orion(formatter.format_measurement(m, loc['name']))
            except Exception as e:
